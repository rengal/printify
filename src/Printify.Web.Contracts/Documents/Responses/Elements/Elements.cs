...
public abstract record ResponseElement(int Sequence) : BaseElement(Sequence);

/// <summary>
/// Marker base for printing response elements that render visible output.
/// </summary>
/// <param name="Sequence">Monotonic sequence index within the document stream.</param>
public abstract record ResponsePrintingElement(int Sequence) : PrintingElement(Sequence);

/// <summary>
/// Marker base for response elements that modify state or report diagnostics.
/// </summary>
/// <param name="Sequence">Monotonic sequence index within the document stream.</param>
public abstract record ResponseNonPrintingElement(int Sequence) : NonPrintingElement(Sequence);

/// <summary>
/// An audible/attention bell signal.
/// </summary>
/// <param name="Sequence">Monotonic sequence index within the document stream.</param>
public sealed record Bell(int Sequence) : ResponseNonPrintingElement(Sequence);
...
public sealed record Error(int Sequence, string Code, string Message) : ResponseNonPrintingElement(Sequence);

/// <summary>
/// A paper cut operation (full or partial depending on command parsed).
/// </summary>
/// <param name="Sequence">Monotonic sequence index within the document stream.</param>
public sealed record Pagecut(int Sequence) : ResponseNonPrintingElement(Sequence);
...
public sealed record PrinterError(int Sequence, string Message) : ResponseNonPrintingElement(Sequence);
...
public sealed record PrinterStatus(int Sequence, byte StatusByte, string? Description)
    : ResponseNonPrintingElement(Sequence);
...
public sealed record PrintBarcode(
    ...
    string? Sha256,
    Uri Href)
    : ResponsePrintingElement(Sequence);
...
public sealed record StoreQrData(int Sequence, string Content) : ResponseNonPrintingElement(Sequence);
...
public sealed record TextLine(int Sequence, string Text) : ResponsePrintingElement(Sequence);
...
public sealed record StoredLogo(int Sequence, int LogoId) : ResponsePrintingElement(Sequence);

/// <summary>
/// Resets the printer to its power-on state (ESC @).
/// </summary>
/// <param name="Sequence">Monotonic sequence index within the document stream.</param>
public sealed record ResetPrinter(int Sequence) : ResponseNonPrintingElement(Sequence);
...
public sealed record SetBarcodeHeight(int Sequence, int HeightInDots) : ResponseNonPrintingElement(Sequence);
...
public sealed record SetBoldMode(int Sequence, bool IsEnabled) : ResponseNonPrintingElement(Sequence);
...
public sealed record SetCodePage(int Sequence, string CodePage) : ResponseNonPrintingElement(Sequence);
...
public sealed record SetLineSpacing(int Sequence, int Spacing) : ResponseNonPrintingElement(Sequence);

/// <summary>
/// Resets the line spacing to the device default value.
/// </summary>
/// <param name="Sequence">Monotonic sequence index within the document stream.</param>
public sealed record ResetLineSpacing(int Sequence) : ResponseNonPrintingElement(Sequence);
...
public sealed record SetQrModel(int Sequence, QrModel Model) : ResponseNonPrintingElement(Sequence);
...
public sealed record SetReverseMode(int Sequence, bool IsEnabled) : ResponseNonPrintingElement(Sequence);
...
public sealed record SetUnderlineMode(int Sequence, bool IsEnabled) : ResponseNonPrintingElement(Sequence);
