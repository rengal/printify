...
public abstract record RequestElement : BaseElement;

/// <summary>
/// Marker base for printing request elements that render visible output.
/// </summary>
public abstract record RequestPrintingElement : PrintingElement;

/// <summary>
/// Marker base for request elements that modify state or report diagnostics.
/// </summary>
public abstract record RequestNonPrintingElement : NonPrintingElement;

/// <summary>
/// An audible/attention bell signal.
/// </summary>
public sealed record Bell : RequestNonPrintingElement;
...
public sealed record Error(string Code, string Message) : RequestNonPrintingElement;

/// <summary>
/// A paper cut operation (full or partial depending on command parsed).
/// </summary>
public sealed record Pagecut : RequestNonPrintingElement;

/// <summary>
/// Represents a printer-specific error emitted during tokenization (e.g., simulated buffer overflow).
/// </summary>
/// <param name="Message">Human-readable description of the error.</param>
public sealed record PrinterError(string Message) : RequestNonPrintingElement;
...
public sealed record StoreQrData(string Content) : RequestNonPrintingElement;
...
public sealed record TextLine(string Text) : RequestPrintingElement;
...
public sealed record StoredLogo(int LogoId) : RequestPrintingElement;

/// <summary>
/// Resets the printer to its power-on state (ESC @).
/// </summary>
public sealed record ResetPrinter : RequestNonPrintingElement;

/// <summary>
/// Configures the height of subsequent barcodes using GS h (0x1D 0x68).
/// </summary>
/// <param name="HeightInDots">Barcode height in dots.</param>
public sealed record SetBarcodeHeight(int HeightInDots) : RequestNonPrintingElement;
...
public sealed record SetBoldMode(bool IsEnabled) : RequestNonPrintingElement;
...
public sealed record SetCodePage(string CodePage) : RequestNonPrintingElement;
...
public sealed record SetLineSpacing(int Spacing) : RequestNonPrintingElement;

/// <summary>
/// Resets the line spacing to the device default value.
/// </summary>
public sealed record ResetLineSpacing : RequestNonPrintingElement;
...
public sealed record SetQrModel(QrModel Model) : RequestNonPrintingElement;
...
public sealed record SetReverseMode(bool IsEnabled) : RequestNonPrintingElement;
...
public sealed record SetUnderlineMode(bool IsEnabled) : RequestNonPrintingElement;
