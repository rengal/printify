...
public sealed record AppendText(byte[] TextBytes) : EscPosCommand;

/// <summary>
/// Flushes the current line buffer and feeds one line.
/// </summary>
public sealed record PrintAndLineFeed : EscPosCommand;

/// <summary>
/// Legacy carriage return kept for compatibility; ignored by the printer.
/// </summary>
public sealed record LegacyCarriageReturn : EscPosCommand;
...
public sealed record SetBoldMode(bool IsEnabled) : EscPosCommand;
...
public sealed record SetUnderlineMode(bool IsEnabled) : EscPosCommand;
...
public sealed record SetReverseMode(bool IsEnabled) : EscPosCommand;
...
public sealed record SetLineSpacing(int Spacing) : EscPosCommand;

/// <summary>
/// Resets the line spacing to the printer default value.
/// </summary>
public sealed record ResetLineSpacing : EscPosCommand;
...
public sealed record SetCodePage(string CodePage) : EscPosCommand;
...
public sealed record StoredLogo(int LogoId) : EscPosCommand;
