...
public sealed class EscPosCommandTrieProvider : CommandTrieProvider<ICommandDescriptor>
{
    ...
    [
        ...
        new CancelBoldModeDescriptor(),
        new SetDoubleStrikeModeDescriptor(),
        new EnableItalicModeDescriptor(),
        new DisableItalicModeDescriptor(),
        new SetFontDescriptor(),
        new SetChineseCodePageDescriptor(),
        new SetCodePageDescriptor(),
        new SetPrintModeDescriptor(),
        new SetCharacterSizeDescriptor(),
        new SetRightCharacterSpacingDescriptor(),
        new SetUpsideDownModeDescriptor(),
        new HorizontalTabDescriptor(),
        new SetHorizontalTabStopsDescriptor(),
