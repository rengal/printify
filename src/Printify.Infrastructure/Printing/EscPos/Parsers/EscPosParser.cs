...
namespace Printify.Infrastructure.Printing.EscPos.Parsers;
...
public sealed class EscPosParser : Parser<EscPosDeviceContext, EscPosCommandTrieProvider>
{
    ...
    /// </summary>
    public EscPosParser(EscPosCommandTrieProvider trieProvider, Action<Command> onElement)
