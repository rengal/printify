...
namespace Printify.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251227000000_AddElementLengthInBytes")]
    partial class AddElementLengthInBytes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Printify.Infrastructure.Persistence.Entities.Printers.PrinterEntity", b =>
                {
                    ...
                    b.Property<string>("RuntimeStatusError")
                        .HasColumnType("TEXT")
                        .HasColumnName("runtime_status_error");

                    b.Property<DateTimeOffset?>("RuntimeStatusUpdatedAt")
                        .HasColumnType("TEXT")
                        .HasColumnName("runtime_status_updated_at");
                    ...
                    b.HasIndex("ListenTcpPortNumber")
                        .IsUnique();
