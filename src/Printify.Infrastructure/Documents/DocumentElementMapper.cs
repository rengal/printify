...
public static class DocumentElementMapper
{
    ...
    public static DocumentElementPayload ToDto(Element element)
    {
        ...
        return element switch
        {
            ...
            AppendText append => new AppendToLineBufferElementPayload(append.RawBytes),
    ...
    public static Element ToDomain(DocumentElementPayload dto, Media? media = null)
    {
        ...
        return dto switch
        {
            ...
            AppendToLineBufferElementPayload textLine => new AppendText(textLine.RawBytes ?? Array.Empty<byte>()),
