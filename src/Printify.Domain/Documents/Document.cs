...
/// <param name="CreatedAt">Creation timestamp (UTC) when the document was finalized or captured.</param>
...
/// <param name="IsDeleted">Soft-delete marker for the document.</param>
