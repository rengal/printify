...
public sealed record AdminWorkspaceStatistics(
    int TotalWorkspaces,
    ...
    IReadOnlyList<AdminWorkspaceStatisticsRow> Workspaces) : IResponse;

public sealed record AdminWorkspaceStatisticsRow(
    Guid WorkspaceId,
